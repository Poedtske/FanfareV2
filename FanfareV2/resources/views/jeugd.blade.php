...
<section style="background-color: black;">
  ...
  <section style="background-color: gray;">
    <p>
      Het instaporkest van onze fanfare staat voor een inspirerende reis door de wereld van muziek. We verwelkomen enthousiaste jongeren en beginnende muzikanten om samen met ons te groeien en te leren.        </p>
    <p>
      Ons doel is om een omgeving te creëren waarin muzikanten van alle niveaus zich kunnen ontwikkelen en hun passie voor muziek kunnen delen. Of je nu een ervaren muzikant bent of net begint, bij ons vind je een plek om je talent te ontplooien.        </p>
      <p>
  ...
  <section style="background-color: white; color: black;">
    <p>
      Bij onze fanfare zetten we in op muzikale groei voor iedereen. We bieden gratis muzieklessen aan voor alle instrumenten die je in een fanfare kunt vinden.        </p>
    <p>
      Of je nu droomt van het spelen van een trompet, saxofoon, slagwerk, of een ander instrument uit de fanfare, onze getalenteerde instructeurs staan klaar om je te begeleiden op jouw muzikale reis. De lessen zijn gratis, zodat iedereen de kans krijgt om zijn passie voor muziek te ontdekken en te ontwikkelen.         </p>
      <p>
  ...
  <section>
    ...
    <p>
      Elk jaar organiseert de jeugdwerking een aantal uitstappen voor de leden. Deze uitstappen kunnen bijvoorbeeld bezoeken aan pretparken, musea, of andere leuke locaties zijn, waar de jongeren samen kunnen genieten van een dag vol avontuur en plezier.        </p>
    <p>
      Naast de grote uitstappen worden er ook kleinere evenementen georganiseerd, zoals de kermis, het snackfestijn en het Sint-Ceciliafeest. Zo zorgen we voor een hechte band en een toffe sfeer in het Instaporkest!        </p>
      <p>
