...
@section('customstyle', 'geschiedenis')
...
<section>
  ...
  <section>
    <p>
      In 1907 werd in het gehucht Borgt, gelegen langs het Rupelkanaal, een muziekvereniging opgericht.
      Deze geboorte verliep niet zonder problemen, want eigenlijk werden er twee verenigingen geboren, en zelfs deze tweeling zag niet tegelijkertijd het levenslicht.
    </p>
    <p>
      Aan het begin van 1907 stichtte een groep muziekliefhebbers een fanfare genaamd "De Nachtegaal" op het grondgebied van Vilvoorde. Maar sommige muzikanten waren het daar niet mee eens en bespraken de mogelijkheid om in Borgt, gelegen op het grondgebied van Grimbergen, een andere fanfare op te richten.        </p>
    <p>
